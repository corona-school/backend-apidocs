define({ "api": [
  ...
  },
  {
    "type": "PUT",
    "url": "/student/:email",
    "title": "updateStudentWithProjectCoachingScreeningResult",
    "version": "1.0.1",
    ...
    "name": "updateStudentWithProjectCoachingScreeningResult",
    "group": "Student",
    "examples": [
      {
        "title": "Curl",
        ...
        "JSON Body": [
          {
            ...
            "optional": false,
            "field": "verified",
            "description": "<p><code>true</code> if the student should be accepted as a project tutor, <code>false</code> otherwise</p>"
          },
          {
            "group": "JSON Body",
            "type": "string|undefined",
            "optional": false,
            "field": "commentScreener",
            "description": "<p>A comment by the screener</p>"
          },
          {
            "group": "JSON Body",
            "type": "string|undefined",
            "optional": false,
            "field": "knowscsfrom",
            "description": "<p>String from where the person knows Corona School's 1-on-1 project coaching</p>"
          },
          {
            "group": "JSON Body",
            "type": "string|undefined",
            "optional": false,
            "field": "screenerEmail",
            "description": "<p>The Screener's email address.</p>"
          },
          {
            "group": "JSON Body",
            "type": "string|undefined",
            "optional": false,
            "field": "feedback",
            "description": "<p>A string with feedback that should be stored.</p>"
          },
          {
            "group": "JSON Body",
            ...
            "optional": false,
            "field": "projectFields",
            "description": "<p>An array of objects providing information on the person's selected project fields.</p>"
          }
        ]
      }
    },
    ...
    "success": {
      "fields": {
        "ProjectFieldInfo Object": [
          {
            "group": "ProjectFieldInfo Object",
            "type": "string",
            "optional": false,
            "field": "projectField",
            "description": "<p>Identifier for the project field, one of <code>&quot;Arbeitswelt&quot;, &quot;Biologie&quot;, &quot;Chemie&quot;, &quot;Geo-und-Raumwissenschaften&quot;, &quot;Mathematik/Informatik&quot;, &quot;Physik&quot;, &quot;Technik&quot;</code></p>"
          },
          {
            "group": "ProjectFieldInfo Object",
            "type": "number",
            "optional": true,
            "field": "max",
            "description": "<p>Maximum grade for this project field. If this is set, <code>min</code> is required as well.</p>"
          },
          {
            "group": "ProjectFieldInfo Object",
            "type": "number",
            "optional": true,
            "field": "min",
            "description": "<p>Minimum grade for this project field. If this is set, <code>max</code> is required as well.</p>"
          }
        ]
      }
    }
