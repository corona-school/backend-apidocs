define({ "api": [
  ...
  },
  {
    ...
    "version": "1.1.0",
    "description": "<p>Create a certificate</p> <p>It is only available for students.</p>",
    "parameter": {
      "fields": {
        "JSON Body": [
          {
            ...
            "optional": false,
            "field": "pupil",
            "description": "<p>UUID of the pupil</p>"
          }
        ],
        "JSON body": [
          {
  ...
  {
    "type": "POST",
    "url": "/course/meeting/external/join/:token",
    "title": "ExternalGuestJoinMeeting",
    "version": "1.1.0",
    "description": "<p>Uses the given token to join the external meeting</p>",
    "parameter": {
      "fields": {
        "URL Parameter": [
          {
            ...
            "optional": false,
            "field": "token",
            "description": "<p>The token that should be used to join the external meeting</p>"
          }
        ]
      }
    },
    "name": "ExternalGuestJoinMeeting",
    "group": "Courses",
    "examples": [
      {
        "title": "Curl",
        "content": "curl -k -i -X POST -H \"Token: <AUTHTOKEN>\" https://api.corona-school.de/api/course/meeting/external/join/:token",
        "type": "curl"
      }
    ],
    "filename": "web/controllers/courseController/index.ts",
  ...
  {
    "type": "POST",
    "url": "/course/:id/inviteexternal",
    "title": "InviteExternalCourseGuest",
    "version": "1.1.0",
    "description": "<p>Sends an invitation to an external course guest.</p>",
    "parameter": {
      "fields": {
        "URL Parameter": [
          {
    ...
    "name": "InviteExternalCourseGuest",
    "group": "Courses",
    "examples": [
      {
        "title": "Curl",
        "content": "curl -k -i -X POST -H \"Token: <AUTHTOKEN>\" https://api.corona-school.de/api/course/<ID>/inviteexternal",
        "type": "curl"
      }
    ],
    "filename": "web/controllers/courseController/index.ts",
    ...
    "success": {
      "fields": {
        "PostExternalInvite Object": [
          {
            "group": "PostExternalInvite Object",
            "type": "string",
            "optional": false,
            "field": "subject",
            "description": "<p>Subject <em>maximum 80 chars</em></p>"
  ...
  {
    "type": "POST",
    "url": "/course/:id/subcourse/:subid/certificate",
    "title": "IssueGroupCertificate",
    "version": "1.1.0",
    "description": "<p>Send a mail to all selected participants and issue them a certificate that is attached to that mail.</p> <p>The course instructors may use this endpoint.</p>",
    "parameter": {
      "fields": {
        "URL Parameter": [
          {
    ...
    "name": "IssueGroupCertificate",
    "group": "Courses",
    "examples": [
      {
        "title": "Curl",
        "content": "curl -k -i -X POST -H \"Token: <AUTHTOKEN>\" https://api.corona-school.de/api/course/<ID>/subcourse/<SUBID>/certificate -d \"<REQUEST\"",
        "type": "curl"
      }
    ],
    "filename": "web/controllers/courseController/index.ts",
    ...
    "success": {
      "fields": {
        "IssueGroupCertificate Object": [
          {
            "group": "IssueGroupCertificate Object",
            "type": "array",
            "optional": false,
            "field": "receivers",
            "description": "<p>An array of pupil UUIDs who should receive the certificate for the corresponding course</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "CheckEmail",
    "version": "1.1.0",
    "description": "<p>Checks if the specified email address is already taken. <b>Has a rate limit of 5 requests/15 minutes per IP-address</b></p>",
    "name": "CheckEmail",
    "group": "Registration",
    "examples": [
      {
        "title": "Curl",
        "content": "curl -k -i -X POST -H \"Content-Type: application/json\" https://api.corona-school.de/api/register/checkEmail -d \"<REQUEST>\"",
        "type": "curl"
      }
    ],
      ...
      "fields": {
        "Tutee Object": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "languages",
            "description": "<p>(optional field) Indicates fluently spoken languges.</p>"
          },
          {
            "group": "Tutee Object",
            "type": "string",
            "optional": true,
            "field": "learningGermanSince",
            "description": "<p>Indicates since when tutee learns German. Allowed values are &quot;&gt;4&quot;, &quot;2-4&quot;, &quot;1-2&quot;, &quot;&lt;1&quot;.</p>"
          },
          {
            "group": "Tutee Object",
            "type": "string",
            "optional": true,
            "field": "cToken",
            "description": "<p>Token for CoDu pupils that gets stored in the DB.</p>"
          }
        ],
        "Subject Object": [
          {
      ...
      "fields": {
        "Tutor Object": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "languages",
            "description": "<p>(optional field) Indicates in which languages the tutor can offer support.</p>"
          }
        ],
        "Subject Object": [
          {
  ...
  },
  {
    ...
    "version": "1.0.1",
    "description": "<p>Request a new token for the user account specified by email.</p> <p>This endpoint allows requesting a new token send via email to the user. A user can only request a new token, if he doesn't have an unused token from the last 24h.</p> <p>A 409 'Conflict' HTTP status code indicates that the user isn't verified yet and that a new verification email has been sent.</p>",
      ...
      "fields": {
        "User Object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "isUniversityStudent",
            "description": "<p><i>Only available for project coaches:</i> The coach is enrolled at a university</p>"
          },
          {
            "group": "User Object",
            "type": "boolean",
      ...
      "fields": {
        "Tutor Object": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "supportsInDaz",
            "description": "<p>Indication whether the student wants to support in the DaZ programme</p>"
          },
          {
            "group": "Tutor Object",
            "type": "string[]",
            "optional": false,
            "field": "languages",
            "description": "<p><i>Only if student supports in DaZ (optional):</i> Languages in which the student can offer support</p>"
          }
        ]
      }
    },
