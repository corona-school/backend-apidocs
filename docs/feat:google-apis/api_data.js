define({ "api": [
  ...
  {
    "type": "POST",
    "url": "/course/:id/meeting/join",
    "title": "JoinCourseMeeting",
    "version": "1.1.0",
    "description": "<p>Joins the BBB-Meeting for a given course</p> <p>This endpoint allows joining the BBB-Meeting of a course. If the user is the instructor of the course the Meeting gets created with this call. The other participants can only join after the instructor created the meeting with this endpoint</p>",
    "name": "JoinCourseMeeting",
    "group": "Courses",
    "parameter": {
      "fields": {
        "JSON Body": [
          {
            ...
            "optional": false,
            "field": "subcourseId",
            "description": "<p>ID of the subcourse of the course that should be joined</p>"
          }
        ]
      }
    },
    "examples": [
      {
        "title": "Curl",
        "content": "curl -k -i -X POST -H \"Token: <AUTHTOKEN>\" https://api.corona-school.de/api/course/<ID>/meeting/join",
        "type": "curl"
      }
    ],
    "filename": "web/controllers/courseController/index.ts",
